...
public class Config {
    public static final String YOUR_EMAIL = "cashapp@gmail.com";
    public static final String LINK_TO_SHARE = "http://google.com.vn";
    ...
    public static final int REWARD_ICON[] = {
            ...
            R.drawable.ic_gamestop, R.drawable.ic_gamestop,
            R.drawable.ic_rizty,
    ...
    public static final String[] PP_REWARDS = {
            "1$ iTunes Gift Card", "$2 iTunes Canada Gift  Card", "$5 iTunes Gift Card", "$10 iTunes Canada Gift  Card", "$25 iTunes Gift Card",
            "$1 Amazon.com Gift Card", "$2 Amazon.com Gift Card", "$5 Amazon.com Gift Card", "$10 Amazon.com Gift Card", "$25 Amazon.com Gift Card",
            "$2 eBays Gift Card", "$5 eBays Gift Card", "$10 eBays Gift Card", "$25 eBays Gift Card",
            "$5 Google Play Gift Card", "$10 Google Play Gift Card", "$25 Google Play Gift Card",
            "$5 GameStop Gift Card", "$10 GameStop Gift Card",
            "$10 Rixty Gift Card",
            "$10 Trion Gift Card",
            "$25 Best Buy Gift Card",
            "$5 XBox Digital Gift Card",
            "$10 Gap Gift Card",
            "$5 Applebee's Gift Card",
            "$10 Sears Gift Card",
            "$10 Starbucks Gift Card",

    };

    public static final String PREFERENCES_NAME = "cashapp";
    public static final String PREFERENCES_KEY = "whatthefuck";
